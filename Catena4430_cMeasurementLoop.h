...
class cMeasurementFormat32 : public cMeasurementBase
    {
public:
    static constexpr uint8_t kMessageFormat = 0x32;
    ...
    static constexpr size_t kTxBufferSize = (1 + 4 + 1 + 2 + 2 + 2 + 1 + 6 + 3 + 6 + kMaxActivityEntries * 2);
...
public:
    ...
    using MeasurementFormat = cMeasurementFormat32<kMaxActivityEntries>;
